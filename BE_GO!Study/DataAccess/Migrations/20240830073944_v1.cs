        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_PrivacySettings_PrivacySettingId",
                        column: x => x.PrivacySettingId,
                        principalTable: "PrivacySettings",
                        principalColumn: "PrivacySettingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rankings", x => x.RankId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EncryptionKeys", x => x.EncryptionKeyId);
                    table.ForeignKey(
                        name: "FK_EncryptionKeys_Data_DataId",
                        column: x => x.DataId,
                        principalTable: "Data",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Analytics_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "ClassroomId");
                    table.ForeignKey(
                        name: "FK_Analytics_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Analytics_ClassroomId",
                table: "Analytics",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_Analytics_TaskId",
                table: "Analytics",
                column: "TaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PrivacySettingId",
                table: "Users",
